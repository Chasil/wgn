...
$sql = "SELECT * FROM `simc` WHERE rodz_gmi = 5 or rodz_gmi = 2";
...
$statement2 = $db->prepare('INSERT INTO wies (nazwa,woj,pow,gm,rodz,id_woj,id_pow,id_gm) VALUES(:name,:woj,:pow,:gm,:rodz,:id_woj,:id_pow,:id_gm)');
